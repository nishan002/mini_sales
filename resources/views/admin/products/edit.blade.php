...
@section('content')
    <h3>Edit Product</h3>
    <form id="product-form" method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="purchase_price" class="form-control mb-2" value="{{ $product->purchase_price }}"/>
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="sales_price" class="form-control mb-2" value="{{ $product->sales_price }}"/>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <textarea id="description" class="form-control" name="description" rows="12">{{ $product->description }}</textarea>
