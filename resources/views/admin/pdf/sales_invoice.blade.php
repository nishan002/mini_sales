        ...
        <div class="invoice-details">
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    <h4 class="invoice-details-title">Bill To:</h4>
                    <ul class="details-list">
                        <li class="list"> <strong>Name:</strong>  {{ $sale->customer->name }} </li>
                        <li class="list"> <strong>Address:</strong> {{ $sale->customer->address }} </li>
                        <li class="list"> <strong>Phone:</strong> {{ $sale->customer->phone_number }} </li>
                    </ul>
                </div>
                <div class="invoice-single-details" style="float:right;margin-top:-120px;">
                    <h4 class="invoice-details-title">{{ $sale->invoice_id }}</h4>
                    <ul class="details-list">
                        <li class="list"> <strong>Date: </strong> {{ $date }} </li>
                    </ul>
                </div>
            </div>
        </div>

        <div class="item-description" style="margin-top: 50px;">
